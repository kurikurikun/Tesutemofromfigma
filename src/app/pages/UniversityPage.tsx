...
export function UniversityPage() {
  ...
  const howItWorks = [
    {
      number: '01',
      title: '日常環境だから',
      description: '自身のスマホに向けて話すことで、\nリラックスした状態でリアルな話を聞くことができる',
    },
    {
      number: '02',
      title: '専用ソフトで高品質に収録',
      description: 'ログイン・サインアップ不要の専用ソフトで収録することで、\n音声・映像の品質を保ちながら、気軽にインタビューを受けられる',
    },
    {
      number: '03',
      title: '学生の情報収集チャネルに最適化',
      description: 'ターゲットとなる学生が日常的に使うSNSに適したコンテンツとして活用できる',
    },
  ];
  ...
  const values = [
    {
      title: '動画素材がすぐ使える',
      description: 'SNSや説明会に使用するために適した\n縦型、横型の動画素材が手に入る',
    },
    {
      title: '制作の手間が減る',
    ...
    {
      title: '説明会の効率化',
      description: '学校での説明会に複数の在学生を呼ばなくても\nテステモの動画で伝える',
    },
    {
      title: 'オンライン導線の強化',
      description: 'パンフレットに在学生の声でみれるQRコードを貼る',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 bg-[#7e91cf] z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={() => handleContactClick('university-header')}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                大学の<span className="text-[#e95228]">「ファン」</span>である学生の声で、<br />
                次の入学者を迎える
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                <span className="text-[#e95228] font-semibold">リアルな声</span>でターゲットとなる学生の共感を生み<br />
                <span className="text-[#e95228] font-semibold">安価</span>で手に入る大学の動画プロモーション
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  onClick={() => handleContactClick('university-hero-contact')}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">大学として情報発信はしているものの、<br />実際にはこんな課題を感じていませんか？</p>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-gray-100 to-gray-50 rounded-2xl p-8 border-l-4 border-[#e95228]">
              <p className="text-xl text-gray-700 leading-relaxed">
                結果として、<br />
                大学の魅力が十分に伝わらず、志願者とのミスマッチが起きている。
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="max-w-3xl mx-auto space-y-2">
              <p className="text-lg text-gray-700">
                横型は大学サイトや説明会で<span className="font-bold" style={{ color: '#e95228' }}>「しっかり伝える」</span>ために
              </p>
              <p className="text-lg text-gray-700">
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">導入することで、大学の広報・募集活動はこう変わります</p>
          </motion.div>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-[#e95228] bg-opacity-10 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-3 h-3 bg-[#e95228] rounded-full" />
                  </div>
      ...
      <section className="py-24 bg-gradient-to-b from-[#d4d9f0] to-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
              ...
              <Slider ref={sliderRef} {...sliderSettings}>
                ...
                <div>
                  <div className="px-4">
                    <div className="aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-xl">
                      <iframe
                        src="https://player.vimeo.com/video/1077851874?h=4cc1f2e2a6&badge=0&autopause=0&player_id=0&app_id=58479"
                        className="w-full h-full"
                        frameBorder="0"
                        allow="autoplay; fullscreen; picture-in-picture"
                        allowFullScreen
                ...
                <div>
                  <div className="px-4">
                    <div className="aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-xl">
                      <iframe
                        src="https://player.vimeo.com/video/1077854511?h=4e8398acf7&badge=0&autopause=0&player_id=0&app_id=58479"
                        className="w-full h-full"
                        frameBorder="0"
                        allow="autoplay; fullscreen; picture-in-picture"
                        allowFullScreen
                ...
                <div>
                  <div className="px-4">
                    <div className="aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-xl">
                      <iframe
                        src="https://player.vimeo.com/video/1077853072?h=82e17e407b&badge=0&autopause=0&player_id=0&app_id=58479"
                        className="w-full h-full"
                        frameBorder="0"
                        allow="autoplay; fullscreen; picture-in-picture"
                        allowFullScreen
          ...
          >
            ...
            <div className="flex items-center justify-center gap-6 mb-12">
              <img src={kansaiLogo} alt="関西大学" className="h-20" />
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-8 border-l-4 border-[#e95228] shadow-sm">
                <p className="text-gray-700 leading-relaxed">
                  年間何度も実施している併設校や受験生向けの学部説明会の際に、
                  毎回学生に10分ほどのプレゼンのために来てもらうのは大変なので、このTesuTemo動画を活用させてもらっています。
                  前後に先生のプレゼンもあるので、ゼミの説明や学部留学プログラムの概要はそちらで紹介し、
                  途中で学生の声を挟んで<span className="text-[#e95228] font-semibold">説明会にメリハリ</span>をつけています。
                </p>
              </div>

              <div className="bg-white rounded-2xl p-8 border-l-4 border-[#e95228] shadow-sm">
                <p className="text-gray-700 leading-relaxed">
                  また、春に向けて制作している学部パンフレットの中で、ゼミ活動の紹介のページや
                  学部留学プログラムのページに<span className="text-[#e95228] font-semibold">QRコードを掲載</span>して、
                  TesuTemo動画を学部のHPにアップロードさせていただき、そのページにとぶように準備をしています。
                </p>
              </div>

              <div className="bg-white rounded-2xl p-8 border-l-4 border-[#e95228] shadow-sm">
                <p className="text-gray-700 leading-relaxed">
                  既存のHPや学部パンフレットや学部説明会などのスライドにTesuTemo動画を受けとることで、
                  わざわざ学生の手配をしていた<span className="text-[#e95228] font-semibold">手間やコストも減らせる</span>ことができるので、
                  私たちはとても重宝しています。
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            >
              ...
              <button
                onClick={() => handleContactClick('university-pricing-sns')}
            ...
            >
              ...
              <button
                onClick={() => handleContactClick('university-pricing-featured')}
            ...
            >
              ...
              <button
                onClick={() => handleContactClick('university-pricing-option')}
                className="w-full py-4 bg-[#e95228] text-white rounded-xl font-semibold hover:bg-[#c74320] transition-all duration-300"
              >
                コンタクト
              </button>
      ...
      {/* Contact Section */}
      <Contact 
        organizationLabel="学名"
        organizationPlaceholder="テステモ大学"
      />
