...
export function MunicipalityPage() {
  ...
  const howItWorks = [
    ...
    {
      number: '03',
      title: '移住検討者の情報収集チャネルに最適化',
      description: 'ターゲットとなる移住検討者が日常的に使うSNSに適したコンテンツとして活用できる',
    },
  ];
  ...
  const values = [
    {
      title: '動画素材がすぐ使える',
      description: 'SNSや移住相談会・イベントで使用するために適した\n縦型・横型の動画素材が手に入る',
    },
    {
      title: '制作の手間が減る',
    ...
    {
      title: '移住促進の導線を強化',
      description: 'パンフレットや移住サイトに動画を組み込むことで、\n相談・来訪につながる導線をつくる',
    },
  ];
      ...
      <header className="fixed top-0 left-0 right-0 bg-[#7e91cf] z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={() => handleContactClick('municipality-header')}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                地域の<span className="text-[#e95228]">「ファン」</span>である先輩移住者の声で、<br />
                次の移住者を迎える
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                <span className="text-[#e95228] font-semibold">リアルな声</span>で移住者の共感を生み<br />
                <span className="text-[#e95228] font-semibold">安価</span>で手に入る移住の動画プロモーション
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  onClick={() => handleContactClick('municipality-hero-contact')}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">自治体として情報発信はしているものの、<br />実際にはこんな課題を感じていませんか？</p>
          </motion.div>
          ...
          >
            ...
            <div className="max-w-3xl mx-auto space-y-2">
              <p className="text-lg text-gray-700">
                横型は移住サイトや説明会・イベントで<span className="font-bold" style={{ color: '#e95228' }}>「しっかり伝える」</span>ために
              </p>
              <p className="text-lg text-gray-700">
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">導入することで、自治体の広報・移住促進はこう変わります</p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            >
              ...
              <button
                onClick={() => handleContactClick('municipality-pricing-sns')}
            ...
            >
              ...
              <button
                onClick={() => handleContactClick('municipality-pricing-featured')}
            ...
            >
              ...
              <button
                onClick={() => handleContactClick('municipality-pricing-option')}
                className="w-full py-4 bg-[#e95228] text-white rounded-xl font-semibold hover:bg-[#c74320] transition-all duration-300"
              >
                コンタクト
              </button>
